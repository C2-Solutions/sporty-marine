...
<div style="text-align: center;">
    <h1 style="margin-left: auto; margin-right: auto; color: dimgray;">Sporty Marine</h1>
</div>
<hr class="card-header border-2 border-top border-grey">
<div class="card">
    <div class="card-body">
        <div class="float-right" style="width: 50%;">
            <div>
                ...
                world has never seen. Does everybody know that pig named Lorem Ipsum? An ‘extremely credible source’
        ...
        <iframe width="560" height="315"
                src="https://www.youtube.com/embed/z-f8yNgcv5Y?start=3&autoplay=0&loop=1&control=0"
